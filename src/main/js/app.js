...
class MainScene extends Phaser.Scene {
    ...
    create(config) {
        ...
        if(!colorPickerBlock) {
            ...
            colorPickerBlock.style.cssText = 'display:none;position:absolute;width:250px;height:80px;opacity:1.0;z-index:1;background:#222;top:200px;left:80px;color:#ccc';
