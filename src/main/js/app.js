...
class CourseColorButton extends Button {
    ...
    onButtonClick() {
        ...
        let htmlText = '<div style="padding: 32px;"><div><span><input type="color" value="#ff0000"> Course Color</span></div><div><span><button>Update</button><button>Close</button></span></div></div>';
